...
const marketingCopyBase = {
  zh: {
    ...
    home: {
      ...
      caseTeaser: {
        eyebrow: '继续了解',
        title: '想看我们具体怎么做，可以直接进入行业方案和真实案例',
        body: '一个更偏行业方法，一个更偏实际项目结果，放在一起会更容易看清 WanFlow 的交付方式。',
        footer: '从行业方案进入，也可以直接对照真实案例',
        items: [],
      },
      finalCta: {
        eyebrow: '下一步',
    ...
    solutions: {
      ...
      industries: [
        ...
        },
        {
          ...
          imageSrc: '/industry-assets/retail/hero-v2.png',
    ...
    about: {
      ...
      credentials: {
        eyebrow: '企业资质',
        title: '研究与知识产权，服务于真实交付',
        body: '围绕多智能体执行、工作流智能、模型运营与可审计交付，团队持续沉淀可验证的方法研究与知识产权资产。',
        tabs: {
          papers: '论文',
          patents: '专利',
        ...
        papers: [
          {
            title: '企业多智能体执行中的审计与轨迹建模研究',
            year: '2025',
            venue: '国际 AI 应用研究会议',
            description: '围绕多智能体协同状态、证据留痕与人工复核信号建立统一建模方法，用于提升 Agent 执行链路的可审计性与回放效率。',
            status: '已发表',
            tag: '多智能体治理',
            previewCode: 'AGENT',
            previewStamp: '已发表',
          ...
          {
            title: '面向 Agent 文档处理链路的工作流编排与回退机制研究',
            year: '2024',
            venue: '智能系统方向期刊',
            description: '总结 AI 文档抽取、智能工作流调度、人工兜底与异常回退之间的协同框架，支撑长链路文档处理在生产环境中的稳定运行。',
            status: '已发表',
            tag: 'Agent 工作流',
            previewCode: 'DOCFLOW',
            previewStamp: '已发表',
          ...
          {
            title: '面向 AI 系统运营的数据治理与评测闭环方法',
            year: '2024',
            venue: '数据智能应用论坛',
            description: '围绕数据质量、在线反馈、Agent 结果回流与版本回溯设计模型运营评测框架，帮助团队把 AI 效果验证接进日常迭代。',
            status: '已发表',
            tag: 'AI Model Ops',
            previewCode: 'MODELOPS',
            previewStamp: '已发表',
          },
          {
            title: '高要求业务中的 Agent 与人机协同决策架构',
            year: '2023',
            venue: '高可靠 AI 专题研讨',
            description: '讨论在高要求场景下，如何将 Agent 自动决策、人工复核与权限边界组合为分层执行架构。',
            status: '已发表',
            tag: 'Agent + HITL',
            previewCode: 'HITL',
            previewStamp: '已发表',
        ...
        patents: [
          {
            title: '一种面向 Agent 协同执行的状态编排与追踪方法',
            year: '2025',
            venue: '中国发明专利',
            description: '覆盖任务拆分、角色路由、证据留痕与异常升级，适用于企业 Agent 与多角色协同执行场景。',
            status: '已授权',
            tag: 'Agent 编排',
            previewCode: 'ORCH',
            previewStamp: '授权',
          ...
          {
            title: '一种 AI 文档处理中的质量校验与人工回退方法',
            year: '2024',
            venue: '中国发明专利',
            description: '针对 PDF、表格与非结构化文本混合处理，建立 AI 抽取、抽检与人工回退联动机制。',
            status: '实审中',
            tag: 'AI 文档智能',
            previewCode: 'DOCSYS',
            previewStamp: '实审',
          ...
          {
            title: '一种 AI 模型运营中的在线评测与反馈闭环方法',
            year: '2024',
            venue: '国际专利申请',
            description: '将线上反馈、效果判定、Agent 样本回流与版本策略接入统一运营闭环，支持 AI 模型持续优化。',
            status: '已受理',
            tag: 'AI Model Ops',
            previewCode: 'EVAL',
            previewStamp: '受理',
          ...
          {
            title: '一种具备权限边界控制的企业 AI 交付工作台方法',
            year: '2023',
            venue: '中国发明专利',
            description: '面向企业交付过程中的权限隔离、任务留痕、Agent 协同与多角色控制，提升上线后的可追踪性与治理能力。',
            status: '已授权',
            tag: 'AI 交付治理',
            previewCode: 'WORKBENCH',
            previewStamp: '授权',
          },
        ],
        softwareCopyright: [
          {
            title: '多智能体协同编排平台 V1.0',
            year: '2025',
            venue: '软件著作权登记',
            description: '覆盖任务拆分、角色调度、状态同步与异常升级，支撑企业多智能体与 Agent 任务在统一工作台中的稳定执行。',
            status: '已登记',
            tag: 'Agent 平台',
            previewCode: 'PLATFORM',
            previewStamp: '登记',
          },
          {
            title: 'AI 文档智能处理与回退系统 V1.0',
            year: '2024',
            venue: '软件著作权登记',
            description: '面向复杂文档抽取、智能校验、人工回退与结果追踪，服务长链路 AI 文档处理场景。',
            status: '已登记',
            tag: 'AI 文档智能',
            previewCode: 'ENGINE',
            previewStamp: '登记',
          ...
          {
            title: 'AI 模型运营评测闭环平台 V1.0',
            year: '2024',
            venue: '软件著作权登记',
            description: '将在线反馈、效果对账、样本回流与版本管理连成一体，帮助 AI 模型运营形成可复盘的评测闭环。',
            status: '已登记',
            tag: 'AI Model Ops',
            previewCode: 'LOOP',
            previewStamp: '登记',
          ...
          {
            title: 'Agent 人机协同交付工作台 V1.0',
            year: '2023',
            venue: '软件著作权登记',
            description: '面向企业交付中的任务分派、人工复核、Agent 协同、权限边界与留痕追踪，提升复杂流程的可管理性。',
            status: '已登记',
            tag: 'Agent 交付',
            previewCode: 'CONSOLE',
            previewStamp: '登记',
  ...
  en: {
    ...
    footer: {
      ...
      copyright: 'Copyright 2026 wanflowai.com. All rights reserved.',
      legal: 'Built around real delivery work, then refined through repeated execution and review.',
      legalLinks: [
    ...
    home: {
      ...
      caseTeaser: {
        ...
        title: 'If you want more detail, go straight to industry solutions and real cases',
        body: 'One shows the delivery logic by industry. The other shows how the work landed in real projects.',
        footer: 'Start from the industry view or jump straight into cases',
        items: [],
      },
      finalCta: {
        eyebrow: 'Next step',
    ...
    cases: {
      intro: {
        eyebrow: 'Real Cases',
        title: 'Cases from real delivery work should show what changed and what the result was.',
        body: 'Focus on the original business problem, the delivery scope, and the outcome.',
      },
      cards: [
        {
        ...
        {
          title: 'Exception and inventory coordination redesign for a discrete manufacturer',
          sector: 'Manufacturing & Supply Chain',
          client: 'A discrete manufacturing enterprise',
          stats: ['First response down about 34%', 'Manual inventory checks down about 29%', 'Exception closure time down about 22%'],
          originalMethod: 'Exception triage, inventory mapping, and ownership closure in one workbench',
          aiCapability: 'Automated exception triage with inventory-state coordination',
          technicalTraits: ['Priority recognition for exceptions', 'Inventory field mapping', 'Traceable ownership nodes'],
          challenge: 'Once an issue appeared on the floor, work orders, inventory, and material-prep data lived in separate systems, so production, warehouse, and planning teams had to reconcile everything manually.',
          solution: 'WanFlow connected triage, inventory mapping, task dispatch, and escalation records into one collaborative workbench so frontline, warehouse, and planning teams could work from the same state chain.',
          delivery: 'The system now handles high-frequency exception tickets, inventory checks, and escalations in one place, from detection to closure.',
          deliverables: ['Exception classification rules', 'Inventory-state mapping', 'Priority mechanism for work orders', 'Escalation SOP'],
          outcome: 'After rollout, first response dropped about 34%, manual inventory checks dropped about 29%, and exception closure time dropped about 22%.',
          imageSrc: '/industry-assets/manufacturing/hero.png',
          imageTitle: 'Manufacturing exception and inventory coordination view',
        },
        {
    ...
    about: {
      ...
      credentials: {
        eyebrow: 'Credentials',
        title: 'Research and protected methods behind the delivery model',
        body: 'Across multi-agent execution, workflow intelligence, model operations, and auditable delivery, the team continues to turn field experience into publishable methods and protectable system assets.',
        tabs: {
          papers: 'Papers',
          patents: 'Patents',
        ...
        controls: {
          previous: 'View previous credential',
          next: 'View next credential',
        },
        papers: [
          {
            title: 'Audit and Trace Modeling for Enterprise Multi-Agent Execution',
            year: '2025',
            venue: 'International AI Application Conference',
            description: 'Proposes a unified structure for multi-agent state, evidence trails, and human review signals so enterprise agent execution systems remain auditable under real operating load.',
            status: 'Published',
            tag: 'Agent Governance',
            previewCode: 'AGENT',
            previewStamp: 'Published',
          },
          {
            title: 'Agent Workflow Orchestration and Safe Rollback for Complex Document Processing',
            year: '2024',
            venue: 'Intelligent Systems Journal',
            description: 'Describes a production-oriented coordination pattern across AI document extraction, agent workflow scheduling, human fallback, and exception recovery in long-running processing chains.',
            status: 'Published',
            tag: 'Agent Workflows',
            previewCode: 'DOCFLOW',
            previewStamp: 'Published',
          ...
          {
            title: 'A Data-Governance-Driven Evaluation Loop for AI Model Operations',
            year: '2024',
            venue: 'Applied Data Intelligence Forum',
            description: 'Frames model operations around data quality, online feedback, agent-result return, and version traceability so AI effect validation becomes part of the operating rhythm rather than a side project.',
            status: 'Published',
            tag: 'AI Model Ops',
            previewCode: 'MODELOPS',
            previewStamp: 'Published',
          ...
          {
            title: 'Layered Agent and Human-in-the-Loop Decision Architecture for High-Stakes Business Flows',
            year: '2023',
            venue: 'Reliable AI Workshop',
            description: 'Examines how agent-driven decisions, human review gates, and permission boundaries can be combined into a controlled execution design for high-stakes workflows.',
            status: 'Published',
            tag: 'Agent + HITL',
            previewCode: 'HITL',
            previewStamp: 'Published',
        ...
        patents: [
          {
            title: 'State Orchestration and Traceability Method for Agent-Driven Collaborative Execution',
            year: '2025',
            venue: 'Chinese Invention Patent',
            description: 'Covers task decomposition, role routing, evidence retention, and exception escalation for enterprise-grade collaborative execution across agents and human teams.',
            status: 'Granted',
            tag: 'Agent Orchestration',
            previewCode: 'ORCH',
            previewStamp: 'Granted',
          },
          {
            title: 'Quality Validation and Human Fallback Method for AI Document Processing',
            year: '2024',
            venue: 'Chinese Invention Patent',
            description: 'Protects a coordinated mechanism for AI extraction, spot checking, and human fallback across mixed PDF, table, and free-text processing pipelines.',
            status: 'Under Examination',
            tag: 'AI Document Intelligence',
            previewCode: 'DOCSYS',
            previewStamp: 'Examined',
          },
          {
            title: 'Method for Building an Online Evaluation and Feedback Loop in AI Model Operations',
            year: '2024',
            venue: 'International Patent Application',
            description: 'Connects online feedback, effect scoring, agent sample return, and version strategy into one operating loop for continuous AI model improvement.',
            status: 'Filed',
            tag: 'AI Model Ops',
            previewCode: 'EVAL',
            previewStamp: 'Filed',
          ...
          {
            title: 'Enterprise AI Delivery Workbench Method with Agent Coordination and Permission-Boundary Control',
            year: '2023',
            venue: 'Chinese Invention Patent',
            description: 'Covers permission isolation, execution logging, agent coordination, and multi-role controls that improve governance after go-live.',
            status: 'Granted',
            tag: 'AI Delivery Governance',
            previewCode: 'WORKBENCH',
            previewStamp: 'Granted',
          },
        ],
        softwareCopyright: [
          {
            title: 'Multi-Agent Orchestration Platform V1.0',
            year: '2025',
            venue: 'Software Copyright Registration',
            description: 'Covers task decomposition, role scheduling, state synchronization, and exception escalation for stable enterprise multi-agent and agent-based execution.',
            status: 'Registered',
            tag: 'Agent Orchestration',
            previewCode: 'PLATFORM',
            previewStamp: 'Registered',
          },
          {
            title: 'AI Document Intelligence and Fallback System V1.0',
            year: '2024',
            venue: 'Software Copyright Registration',
            description: 'Built for complex document extraction, intelligent validation, human fallback, and result traceability across long-running AI document flows.',
            status: 'Registered',
            tag: 'AI Document Intelligence',
            previewCode: 'ENGINE',
            previewStamp: 'Registered',
          ...
          {
            title: 'AI Model Operations Evaluation Loop Platform V1.0',
            year: '2024',
            venue: 'Software Copyright Registration',
            description: 'Connects online feedback, effect reconciliation, sample return, and version control into a replayable operating loop for AI model teams.',
            status: 'Registered',
            tag: 'AI Model Ops',
            previewCode: 'LOOP',
            previewStamp: 'Registered',
          ...
          {
            title: 'Agent Human-in-the-Loop Delivery Workbench V1.0',
            year: '2023',
            venue: 'Software Copyright Registration',
            description: 'Supports task dispatch, human review, agent coordination, permission boundaries, and execution traceability for enterprise delivery programs.',
            status: 'Registered',
            tag: 'Agent Delivery',
            previewCode: 'CONSOLE',
            previewStamp: 'Registered',
