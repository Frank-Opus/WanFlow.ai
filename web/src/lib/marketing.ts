...
const marketingCopyBase = {
  zh: {
    ...
    solutions: {
      problemFrame: {
        ...
        body:
          '不讲空概念，直接看每个行业里最容易卡住、最费人、也最影响结果的那几段业务。WanFlow 会先把链路接顺，再把 AI 和多智能体真正接进去。',
      },
      industries: [
        {
          title: '金融与保险',
          headline: '把审核、补件和风控拉回同一条业务链',
          summary: '申请量一上来，审核慢、补件反复、客服转述多、复核压力大，问题往往会一起冒出来。WanFlow 会先把规则、状态和人工兜底接成一条链，让时效、风控和留痕一起稳下来。',
          stats: ['审核时效缩短 35%-55%', '补件回合减少 30%-45%', '人工复核负荷下降 25%-40%', '关键节点留痕覆盖提升至 90%+'],
          originalMethod: '先把规则、状态和复核边界拉齐，再让系统接手高频动作',
          ...
          outcomes: ['高频审核平均处理时长通常能压到原来的 45%-65%', '补件后再次被退回的比例一般可下降 30% 左右', '首轮分发更稳后，客服与审核之间的反复转述会明显减少', '管理层可以按天看到卡点、回退和风险分布，而不是只靠事后抽查'],
          modules: [
            {
              title: '审核与补件流重构',
              body: '把初审、补件、复核、退回、升级重新接成一条状态清晰的流程，减少一份材料来回打转。',
        ...
        {
          title: '制造与供应链',
          headline: '让现场异常、订单和库存不再各跑各的',
          summary: '制造现场最怕的不是出问题，而是问题出来以后各系统、各角色不在一条线上。WanFlow 会把异常分级、状态同步和升级路径先接起来，让一线、计划、仓储和管理层看到的是同一条链。',
          stats: ['异常响应时长缩短 30%-50%', '跨系统跟单人工下降 25%-40%', '升级闭环时长缩短 20%-35%', '库存状态同步准确率提升 20%-30%'],
          originalMethod: '先把异常分级和状态同步接顺，再让任务自动往下跑',
        ...
        {
          title: '零售与电商',
          headline: '把日常经营动作接成一条能复用的运营链',
          summary: '电商团队最累的往往不是做活动，而是每天都在补数字、催协同、追复盘。WanFlow 会先把经营口径统一，再把内容、客服和复盘节奏接到一起，让团队从忙乱切回有节奏的运营。',
          stats: ['周报产出时间缩短 70%-90%', '人工汇总工作量下降 50%-75%', '活动复盘反馈速度提升 2-4 倍', '多平台口径错漏下降 30%+'],
          originalMethod: '先把经营数据归一，再把前台执行和复盘节奏接起来',
        ...
        {
          title: '汽车与零部件制造',
          headline: '把异常、排产和供应协同拉成一条真正能跑的制造链路',
          summary: '汽车与零部件场景里，最怕的是异常、缺料、排产和质量问题不是一个节奏。WanFlow 会先把异常识别、任务分流、计划联动和后续复盘接顺，让现场、计划和供应协同跑在同一条线上。',
          stats: ['异常响应时长缩短 30%-50%', '跨系统跟单人工下降 25%-40%', '计划调整闭环时长缩短 20%-35%', '同班次风险暴露提前 1-2 个处理节点'],
          originalMethod: '先把异常和计划联动接起来，再让 AI 和多智能体往下推进',
          technicalTraits: ['异常分级与优先级', '排产与库存状态同步', '质量与供应闭环复盘'],
          imageSrc: '/industry-assets/automotive/hero.png',
          imageTitle: '建议图片：汽车制造运营看板或供应协同主工作台',
          ...
          modules: [
            {
              ...
              aiCapability: '异常识别与优先级自动判定',
              technicalTrait: '规则与模型混合分诊',
              originalMethod: '产线异常先分级，再自动接力推进',
              imageSrc: '/industry-assets/automotive/triage.png',
              imageTitle: '建议图片：产线异常智能分诊模块',
              deliverables: ['异常分类规则', '工单优先级机制', '升级路径设计'],
              outcome: '异常分派首响时间可缩短 30%-45%',
            },
            {
              ...
              aiCapability: '跨系统状态同步与自动提醒',
              technicalTrait: '多系统字段映射',
              originalMethod: '计划一变，物料和后续动作同步联动',
              imageSrc: '/industry-assets/automotive/sync.png',
              imageTitle: '建议图片：排产与物料协同模块',
              deliverables: ['状态同步流程', '跨系统字段映射', '提醒与回退机制'],
            ...
            },
            {
              ...
              aiCapability: '异常归因与反馈闭环',
              technicalTrait: '运营数据留痕与复盘面板',
              originalMethod: '先自动归因，再把改进动作接回业务',
              imageSrc: '/industry-assets/automotive/review.png',
              imageTitle: '建议图片：质量与供应复盘模块',
              deliverables: ['过程记录结构', '复盘面板', '优化反馈回路'],
        ...
        {
          title: '企业运营与共享服务',
          headline: '让共享服务不再靠人盯人催着跑',
          summary: '财务、人事、行政、客服、法务这些共享服务，最怕的不是事情多，而是流程碎、责任散、回退多。WanFlow 会先把模板、路由和复盘机制搭起来，让重复流程跑得更稳，也让人从催办里退出来。',
          stats: ['重复流程处理时长缩短 30%-50%', '跨岗催办工作量下降 40%-60%', '标准化覆盖率提升至 70%-90%', 'SLA 准时率提升 15%-25%'],
          originalMethod: '先把模板和路由搭好，再让人和智能体一起把流程跑顺',
    ...
    cases: {
      ...
      cards: [
        ...
        },
        {
          ...
          sector: '汽车与零部件制造',
          client: '某汽车零部件企业',
          stats: ['异常首响缩短约 38%', '跨系统跟单人工下降约 31%', '计划调整闭环缩短约 24%'],
          originalMethod: '异常分诊前置加排产联动推进',
          aiCapability: '异常自动分诊与排产物料联动',
          technicalTraits: ['异常分级优先级', '排产与库存状态同步', '升级路径留痕'],
          challenge: '产线异常、缺料波动和排产调整分散在多个系统和角色之间，升级与回退依赖人工协调，导致现场响应慢、责任难追踪',
          solution: '重建异常分发、排产联动和人工兜底规则，并引入多智能体辅助分类、协同和后续推进',
          delivery: '先从高频异常类型切入，逐步补全排产联动、状态同步和人工升级路径',
          deliverables: ['异常分类规则', '工单优先级机制', '排产与状态同步', '升级SOP'],
          outcome: '高频异常首响缩短约 38%，跨系统跟单人工下降约 31%，现场到计划层的调整闭环缩短约 24%',
          imageTitle: '建议图片：汽车制造异常协同看板或排产联动界面',
        },
        {
    ...
    about: {
      hero: {
        eyebrow: '关于我们',
        title: '万流归智（WanFlow）做的，是把 AI 真正接进企业业务里',
        body:
          '我们长期做的是数据、流程、多智能体和模型运营真正落地的那部分硬活。对大多数企业来说，AI 难的从来不是演示，而是上线以后能不能稳定、安全、持续见结果。',
      },
      summary: {
        eyebrow: '公司概览',
        items: [
      ...
      identity: {
        eyebrow: '万流归智（WanFlow）',
        title: '万流归智（WanFlow）是一家面向企业客户的 AI 运营与交付公司',
        paragraphs: [
          '万流归智（WanFlow）长期聚焦企业里最难、也最容易被忽略的那一段：数据怎么准备，流程怎么接顺，AI 和人怎么一起把事情做完，系统上线以后又怎么持续跑稳。尤其在中国市场，很多企业不是不愿意做 AI，而是缺一支既懂业务现实、又能把系统真正接起来的团队。',
      ...
      team: {
        eyebrow: '我们的团队',
        title: '既懂业务现场，也懂系统交付',
        body: '我们更像一支把方案判断、系统搭建、部署上线和后续复盘一起做完的混成团队。',
        members: [
          {
            name: '创始人兼 CEO',
            role: '业务方向与关键项目推进',
            summary: '负责判断项目值不值得做、先做哪一段，以及怎么把业务语言翻译成可落地的系统路径。',
            imageSrc: '/about/team/ceo.svg',
          },
          {
            name: 'CTO',
            role: '平台架构与多智能体系统',
            summary: '负责平台架构、Agent 执行框架、工具接入和安全边界，把系统能力做得稳定、可控、可扩展。',
            imageSrc: '/about/team/cto.svg',
          },
          {
            name: '首席解决方案架构师',
            role: '业务拆解与交付方案设计',
            summary: '负责把复杂业务拆成可以上线的流程、角色边界和协同机制，让方案不是写在纸上，而是能接进现场。',
            imageSrc: '/about/team/solution-architect.svg',
          },
          {
            name: '首席工程师',
            role: '核心系统与数据链路',
            summary: '负责关键系统、数据管线、执行链路和质量机制，把复杂能力真正做成长期可运行的工程底座。',
            imageSrc: '/about/team/chief-engineer.svg',
          },
          {
            name: '前线部署工程师 FDE',
            role: '现场联调与上线落地',
            summary: '负责部署、联调、灰度、现场问题闭环和上线后的第一轮稳定性保障，让方案真正进到业务里。',
            imageSrc: '/about/team/fde.svg',
          },
          {
            name: '交付运营负责人',
            role: '节奏、质量与复盘',
            summary: '负责交付节奏、质量看板、风险追踪和复盘优化，确保项目不是上线即结束，而是能继续跑、继续改。',
  ...
  en: {
    ...
    solutions: {
      ...
      industries: [
        ...
        },
        {
          ...
          headline: 'Turn exceptions, scheduling, and supply coordination into one working manufacturing chain',
          summary: 'For line exceptions, material shortages, schedule adjustments, warehouse coordination, and quality traceability across automotive and parts operations.',
          stats: ['Exception response down 30%-50%', 'Cross-system chasing down 25%-40%', 'Schedule-adjustment closure down 20%-35%'],
          originalMethod: 'Connect exception detection, task routing, schedule linkage, and review first, then let the system keep key steps moving',
          technicalTraits: ['Exception tiering and prioritization', 'Schedule and inventory state synchronization', 'Quality and supply review loops'],
          imageSrc: '/industry-assets/automotive/hero.png',
          imageTitle: 'Suggested image: automotive manufacturing operations cockpit',
          ...
          modules: [
            {
              ...
              originalMethod: 'Triage the line exception first, then let the next step move automatically',
              imageSrc: '/industry-assets/automotive/triage.png',
              imageTitle: 'Suggested image: line-exception triage module',
            ...
            },
            {
              ...
              originalMethod: 'When the schedule moves, material and follow-up actions move with it',
              imageSrc: '/industry-assets/automotive/sync.png',
              imageTitle: 'Suggested image: scheduling and material coordination module',
            ...
            },
            {
              ...
              body: 'Capture causes, actions, quality variance, and recovery outcomes so operations can improve through evidence instead of memory.',
              ...
              originalMethod: 'Auto-summarize the cause first, then push the improvement action back into the workflow',
              imageSrc: '/industry-assets/automotive/review.png',
              imageTitle: 'Suggested image: quality and supply review module',
    ...
    cases: {
      ...
      cards: [
        ...
        },
        {
          ...
          imageTitle: 'Suggested image: automotive exception and scheduling coordination view',
        },
        {
    ...
    about: {
      hero: {
        eyebrow: 'About',
        title: 'WanFlow exists to connect AI to real enterprise operations',
        body:
          'We work on the hard part most teams run into after the demo: getting data, workflows, multi-agent execution, and model operations to run safely and reliably inside the real business.',
      },
      summary: {
      ...
      team: {
        ...
        body: 'The team is structured around solution judgment, system build, frontline deployment, and post-launch optimization.',
        members: [
          {
            name: 'Founder & CEO',
            role: 'Business direction and critical engagements',
            summary: 'Owns project judgment, business alignment, and the path from problem framing to delivery decisions.',
            imageSrc: '/about/team/ceo.svg',
          },
          {
            name: 'CTO',
            role: 'Platform architecture and multi-agent systems',
            summary: 'Leads platform architecture, agent execution, tool integration, and system guardrails.',
            imageSrc: '/about/team/cto.svg',
          },
          {
            name: 'Lead Solutions Architect',
            role: 'Workflow design and delivery structure',
            summary: 'Breaks complex business operations into deployable workflows, role boundaries, and execution paths.',
            imageSrc: '/about/team/solution-architect.svg',
          },
          {
            name: 'Chief Engineer',
            role: 'Core systems and data pipelines',
            summary: 'Builds the engineering backbone behind execution reliability, data movement, and quality controls.',
            imageSrc: '/about/team/chief-engineer.svg',
          },
          {
            name: 'Frontline Deployment Engineer',
            role: 'Launch, integration, and go-live support',
            summary: 'Handles deployment, integration, rollout, and the first line of post-launch stabilization.',
            imageSrc: '/about/team/fde.svg',
          },
          {
            name: 'Delivery Operations Lead',
            role: 'Cadence, quality, and review loops',
            summary: 'Owns delivery rhythm, risk tracking, quality review, and post-launch optimization work.',
            imageSrc: '/about/team/delivery-ops.svg',
          },
        ],
      },
