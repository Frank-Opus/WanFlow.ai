      ...
      industries: [
        {
          ...
          originalMethod: '原先靠人工转单、口径口头对齐，过程留痕少',
        ...
        },
        {
          ...
          stats: ['3 类异常优先处理', '4 个核心状态打通', '1 条协同升级链路'],
          originalMethod: '现场靠电话或群消息升级，状态靠人记',
        ...
        },
        {
          ...
          stats: ['3 类经营数据归集', '4 个运营动作联动', '1 套日报周报输出'],
          originalMethod: '运营人员手工汇总，多平台各自为战',
        ...
        },
        {
          ...
          stats: ['3 类关键知识流程', '4 个受控处理环节', '1 套人工复核闭环'],
          originalMethod: '人工检索与复核为主，口径难统一',
        ...
        },
        {
          ...
          stats: ['3 类共享流程模块', '4 个跨岗协同节点', '1 套持续优化机制'],
          originalMethod: '跨岗协作靠经验推进，标准难沉淀',
      ...
      cards: [
        {
          ...
          sector: '金融与保险',
          client: '某头部消费金融机构',
          stats: ['1 套统一审核规则', '4 个关键节点重连', '3 类交付物落地'],
          originalMethod: '多角色人工转单，表格追踪为主，状态靠口头对齐',
        ...
        },
        {
          ...
          sector: '制造与供应链',
          client: '某制造企业',
          stats: ['3 类异常优先收口', '4 个状态环节打通', '1 套升级机制落地'],
          originalMethod: '异常靠电话/群聊升级，系统间靠人工对账',
        ...
        },
        {
          ...
          sector: '零售与电商',
          client: '某零售电商品牌',
          stats: ['3 类数据统一归集', '4 个动作自动串联', '1 套周报机制上线'],
          originalMethod: '多平台数据手工汇总，周报靠人工撰写',
        ...
        },
        {
          ...
          sector: '医疗与医药',
          client: '某医药服务团队',
          stats: ['1 套知识接入规则', '4 个受控处理环节', '3 类核心材料治理'],
          originalMethod: '知识更新靠人工整理，问答依赖资深人员',
        ...
        },
        {
          ...
          sector: '企业运营与共享服务',
          client: '某大型企业共享服务中心',
          stats: ['3 类高频流程标准化', '4 个跨岗节点重构', '1 套复盘清单沉淀'],
          originalMethod: '跨部门流程靠经验推进，标准难落地',
      ...
      industries: [
        {
          ...
          stats: ['1 unified operating rule set', '4 key processing nodes', '3 high-frequency business modules'],
          originalMethod: 'Manual handoffs and verbal alignment with sparse audit trails',
          ...
          modules: [
            {
              ...
              originalMethod: 'Manual confirmations via email or spreadsheets',
            ...
            },
            {
              ...
              originalMethod: 'Manual handoff with repeated confirmations',
            ...
            },
            {
              ...
              originalMethod: 'After-the-fact sampling or full manual review',
        ...
        },
        {
          ...
          stats: ['3 priority exception groups', '4 synchronized operating states', '1 escalation chain'],
          originalMethod: 'Escalations via calls and chats with status tracked manually',
          ...
          modules: [
            {
              ...
              originalMethod: 'Manual dispatch and phone escalation',
            ...
            },
            {
              ...
              originalMethod: 'Manual reconciliation and follow-ups',
            ...
            },
            {
              ...
              originalMethod: 'Experience-based retrospectives',
        ...
        },
        {
          ...
          stats: ['3 data streams unified', '4 operating actions connected', '1 reporting system'],
          originalMethod: 'Manual rollups across platforms with siloed teams',
          ...
          modules: [
            {
              ...
              originalMethod: 'Manual exports and spreadsheet stitching',
            ...
            },
            {
              ...
              originalMethod: 'Content and service run separately',
            ...
            },
            {
              ...
              originalMethod: 'Manual weekly reports and ad hoc review',
        ...
        },
        {
          ...
          stats: ['3 core knowledge workflows', '4 controlled handling steps', '1 human review loop'],
          originalMethod: 'Manual search and review with inconsistent standards',
          ...
          modules: [
            {
              ...
              originalMethod: 'Manual entry with spot checks',
            ...
            },
            {
              ...
              originalMethod: 'Manual lookup and verbal responses',
            ...
            },
            {
              ...
              originalMethod: 'Fully manual review chains',
        ...
        },
        {
          ...
          stats: ['3 standardized flow groups', '4 cross-role nodes', '1 continuous improvement loop'],
          originalMethod: 'Cross-role coordination by experience with hard-to-retain standards',
          ...
          modules: [
            {
              ...
              originalMethod: 'Each department built its own flow',
            ...
            },
            {
              ...
              originalMethod: 'Offline coordination and manual follow-ups',
      ...
      cards: [
        {
          ...
          stats: ['1 unified review rule set', '4 key nodes reconnected', '3 delivered assets'],
          originalMethod: 'Manual handoffs across roles with spreadsheet tracking',
        ...
        },
        {
          ...
          stats: ['3 priority exception groups', '4 state links synchronized', '1 escalation model'],
          originalMethod: 'Escalations via calls and chats with manual reconciliation across systems',
        ...
        },
        {
          ...
          stats: ['3 data sources unified', '4 operating actions connected', '1 weekly reporting loop'],
          originalMethod: 'Manual multi-platform rollups and weekly reports',
        ...
        },
        {
          ...
          stats: ['1 governed knowledge policy', '4 controlled steps', '3 core material groups'],
          originalMethod: 'Manual knowledge updates with expert-dependent answering',
        ...
        },
        {
          ...
          stats: ['3 high-volume flows standardized', '4 cross-role nodes rebuilt', '1 review backlog'],
          originalMethod: 'Experience-driven cross-department workflows with weak standards',
