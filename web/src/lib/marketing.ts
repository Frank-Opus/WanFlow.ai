    ...
    solutions: {
      ...
      industries: [
        ...
        },
        {
          ...
          summary: '围绕产线异常、缺料波动、排产调整、仓储联动和质量追溯等高频场景，帮助汽车与零部件企业把原本依赖人工协调的处理链做成可追踪、可协同、可持续优化的运营系统',
          stats: ['异常响应时长缩短 30%-50%', '跨系统跟单人工下降 25%-40%', '计划调整闭环时长缩短 20%-35%'],
          originalMethod: '先把异常识别、任务分流、计划联动和后续复盘接顺，再让系统自动推进关键节点',
          ...
          outcomes: ['一线异常从发现到分派可缩短约 40%', '排产与缺料联动后人工催办量可下降约 30%', '高优先级调整闭环可压缩 20%-35%', '供应与质量波动可在班次内更早被识别和处理'],
          modules: [
            {
              title: '产线异常智能分诊',
