    ...
    <>
      ...
      <header id="site-top" className="site-header-shell sticky top-0 z-40">
        <div className="site-topline">
          <div className="mx-auto flex max-w-[88rem] items-center justify-between gap-4 px-5 py-2 text-[0.68rem] uppercase tracking-[0.18em] text-[var(--mk-text-2)] lg:px-8 xl:px-10">
            <p className="truncate">{copy.common.metaKicker}</p>
            <span className="site-pill hidden rounded-full px-3 py-1 text-[var(--mk-text-1)] lg:inline-flex">{copy.site.location}</span>
          </div>
        </div>
        ...
        <div className="mx-auto flex max-w-[88rem] items-center justify-between gap-4 px-5 py-3 lg:px-8 xl:px-10">
            ...
            {copy.nav.map((item) => {
              ...
              return (
                <Link
                  ...
                  className={[
                    'site-nav-link focus-ring rounded-full px-4 py-2 text-[0.92rem] font-medium transition',
          ...
          <button
            ...
            className="mkt-menu-button focus-ring lg:hidden"
          >
